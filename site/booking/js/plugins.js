...
(function($) {
    ...
    $(function() {
        ...
        //lnb
        var $lnb = $header.find('.lnb'), $lnbShow = $lnb.find('.menu_show'), $lnbHide = $lnb.find('.menu_hide'), $lnbDepthItem = $lnb.find('.depth_item'), $lnbMenu = $lnb.find('.menu'), $lnbDepth2FirstChild = $lnbMenu.find('.depth2 > :first-child'), lnbHeight;
